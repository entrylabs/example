...
export const assets = {
    ...
    table: [
        ...
        },
        {
            ...
            "description": "우리나라의 연평균 기온과 계절별 평균 기온 변화의 추이를 알 수 있는 데이터입니다. 이 통계는 전국 평균 데이터로 전문 자료가 아닌 참고용으로 사용하는 값으로 지난 49년간의 계절별 기온 변화 현황을 통해 기후 변화 경향을 파악하는데 사용할 수 있습니다. \n전국 평균은 1973년부터 안정적으로 연속관측을 수행한 62개 지점의 평균값을 사용합니다. 계절 구분은 봄(3-5월), 여름(6-8월), 가을(9-11월), 겨울(당해년12-다음해1,2월)로 했습니다.",
            "exampleurl": null,
